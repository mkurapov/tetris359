 ...
 * @(#)JVM.java
 *
 * $Date: 2015-03-13 09:27:45 -0400 (Fri, 13 Mar 2015) $
 *
...
public class JVM {
	...
	public static boolean isJNLP() {
		try {
			javax.jnlp.BasicService service = (javax.jnlp.BasicService)ServiceManager.lookup("javax.jnlp.BasicService");
			return service.getCodeBase()!=null;
		} catch(Throwable t) {
			return false;
		}
	}
